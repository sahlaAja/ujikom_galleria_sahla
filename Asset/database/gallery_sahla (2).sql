...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Feb 2025 pada 16.00
...
(6, 'timnas!!!', 'timnas Indonesia', '2025-02-09', 2),
(7, 'barca⚽', 'barcelona fc', '2025-02-10', 3),
(8, 'random', 'random photo', '2025-02-10', 4);
...
(6, 'tulip bucket', 'flower', '2025-02-09', 'flower.jpg', 4, 2),
(7, 'korean fried rice', 'food', '2025-02-09', 'food.jpg', 3, 4),
(8, 'Im Sol', 'My gf', '2025-02-09', 'imsol2.jpg', 2, 3),
(9, 'Indo VS Arab', 'win bro!!', '2025-02-09', '4e4bbe76-7166-4be5-86e8-0f7707ba8761.jpg', 6, 2),
(10, 'jersey home', 'new jersey timnas', '2025-02-09', 'new_jersey.jpg', 6, 2),
(11, 'visca barca visca catalunya', 'Juara Supercopa 2024/2025', '2025-02-10', 'FC Barcelona 💙❤️.jpg', 7, 3),
(12, 'UGM', 'my first dream', '2025-02-10', 'Universitas Gadjah Mada.jpg', 4, 2),
(13, 'Pionir 2025', 'ppsmb UGM', '2025-02-10', 'Ppsmb pionir universitas gadjah mada ugm 2024 gsp_.jpg', 4, 2),
(14, 'My room', 'Seoul, South Korea', '2025-02-10', '826e4646-9ddc-406b-a266-8df2f1b36d75.jpg', 8, 4);
...
(1, 6, 4, 'bagusss', '2025-02-10'),
(2, 1, 2, 'lucu banget kaliannn', '2025-02-10');
...
(33, 2, 2, '@sahlaaja menyukai postingan tulip bucket Anda ', 1, '2025-02-10 02:16:15'),
(34, 2, 2, '@sahlaaja menyukai postingan ootd #1 Anda ', 1, '2025-02-10 02:17:34'),
(35, 4, 2, '@sahlaaja menyukai postingan photobooth Anda ', 1, '2025-02-10 02:17:44'),
(36, 2, 4, '@imsol menyukai postingan tulip bucket Anda ', 1, '2025-02-10 02:18:23'),
(37, 2, 4, '@imsol memberi komentar -bagusss- pada postingan tulip bucket Anda ', 1, '2025-02-10 02:18:38'),
(38, 4, 2, '@sahlaaja memberi komentar -lucu banget kaliannn- pada postingan photobooth Anda ', 1, '2025-02-10 14:11:29'),
(39, 2, 2, '@sahlaaja menyukai postingan summer sea cafe Anda ', 0, '2025-02-10 14:23:26'),
(40, 4, 2, '@sahlaaja menyukai postingan korean fried rice Anda ', 1, '2025-02-10 14:23:35');
...
--
ALTER TABLE `foto`
  MODIFY `foto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
