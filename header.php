...
<head>
    ...
    <style>
        ...
        .profil{
            ...
            display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width:auto;
            background: white; padding: 20px; box-shadow: 0px 0px 10px rgba(0,0,0,0.5); border-radius: 20px;
        }
        tr{
            padding: 5px;
        }
        ...
        <div class="header">
          ...
          <div id="profil<?php echo $row['user_id']?>" class="profil">
            <center>
                ...
                <h3>@<?php echo $row['username']?></h3><p><?php echo $row['email']?></p>
            </center>
